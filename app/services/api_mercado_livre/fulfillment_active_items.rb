...
module ApiMercadoLivre
    ...
    class FulfillmentActiveItems < ApplicationService
      ...
      def filter_items
        url = "https://api.mercadolibre.com/users/#{@seller.ml_seller_id}/items/search?search_type=scan&limit=100&logistic_type=fulfillment&status=active"
